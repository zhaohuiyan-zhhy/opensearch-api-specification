...
- Added OpenSearch 3.8 Security API specs for action groups, API tokens, authentication failure listeners, resource sharing, certificate reload, and configuration updates.
